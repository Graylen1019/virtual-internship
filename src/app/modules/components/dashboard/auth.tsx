    ...
    return (
        <div className="w-full py-10 px-6 mx-auto max-w-[1070px]">
            <div className="max-w-[460px] flex flex-col mx-auto items-center">
                ...
                <button className="bg-[#2bd97c] text-[#032b41] w-[180px] h-10 rounded-sm transition-colors duration-200 flex items-center justify-center min-w-[180px] hover:bg-[#20ba68]">Login</button>
            </div>
        </div>
    );
}