...
import { StarIcon, Clock10Icon, MicIcon, LightbulbIcon, BookOpenIcon, BookmarkIcon } from "lucide-react";
        ...
        <div className="gap-4 flex">
            <div className="w-full">
                ...
                <div
                    ...
                    className="flex items-center gap-2 text-[#0365f2] font-medium cursor-pointer mb-10 text-lg transition-colors duration-200 hover:text-[#0356cc]">
